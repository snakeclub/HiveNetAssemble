...
"""The setup.py file for Python HiveNetCore."""
...
SHORT_DESCRIPTION = """
Provides the most commonly used basic objects and basic tool classes.""".strip()
...
setup(
    ...
    keywords="HiveNetAssemble HiveNetCore development python lib",
    url=URL,
    platforms=["all"],
    ...
    entry_points={'console_scripts': [
        "depstool=HiveNetCore.utils.deps_tool:main",
        "pyenvtool=HiveNetCore.utils.pyenv_tool:main"
    ]},
