...
"""The setup.py file for Python HiveNetConsole."""
...
SHORT_DESCRIPTION = """
A simple command line execution framework.""".strip()
...
VERSION = '0.1.0'
URL = 'https://github.com/snakeclub/HiveNetAssemble/HiveNetConsole'
